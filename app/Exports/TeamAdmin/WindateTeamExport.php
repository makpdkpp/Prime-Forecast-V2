...
class WindateTeamExport implements FromQuery, WithHeadings, WithTitle, ShouldAutoSize, WithColumnFormatting, WithMapping
{
    protected $teamIds;
    protected $userId;
    protected $dateFrom;
    ...
    {
        return ['ชื่อโครงการ', 'หน่วยงาน/บริษัท', 'มูลค่า (฿)', 'Windate', 'ชื่อผู้รับผิดชอบ'];
    }
